...
@Component({
  selector: 'app-support-contact-add',
  templateUrl: './support-contact-add.page.html',
  styleUrls: ['./support-contact-add.page.scss'],
})
export class SupportContactAddPage implements OnInit {
