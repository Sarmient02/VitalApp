...
@Component({
  selector: 'app-support-contact-edit',
  templateUrl: './support-contact-edit.page.html',
  styleUrls: ['./support-contact-edit.page.scss'],
})
export class SupportContactEditPage implements OnInit {
  ...
  async editPressedContact(): Promise<void>{
    if(this.contactInfo.clickedEditContact()){
      ...
      this.route.navigate(['support-tabs/contacts']);
    }
  }
